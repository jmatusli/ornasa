...
class Cellmap {
  ...
  function add_frame(Frame $frame) {
    ...
    // 20210420 adapted based on https://github.com/barryvdh/laravel-dompdf/issues/154
    if(method_exists($frame->get_node(), 'getAttribute')){
    ...
    if ( !$colspan ) {
      $colspan = 1;
      if(method_exists($frame->get_node(), 'setAttribute')){
