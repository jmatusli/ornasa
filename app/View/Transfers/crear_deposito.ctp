  ...
  echo "<div class='container-fluid'>";
    ...
    foreach ($undepositedPayments as $paymentInvoiceCashReceipt){
      ...
      if (!empty($paymentInvoiceCashReceipt['Invoice'])){
        ...
        $paymentTableRow="";
        $paymentTableRow.="<tr>";
          $paymentTableRow.="<td class='selector'>".$this->Form->input('Payment.Invoice.'.$payment['id'].'.selector',['checked'=>false,'label'=>false])."</td>";
      ...
      elseif (!empty($paymentInvoiceCashReceipt['CashReceipt'])){  
        ...
        $paymentTableRow="";
        $paymentTableRow.="<tr>";
          $paymentTableRow.="<td class='selector'>".$this->Form->input('Payment.CashReceipt.'.$payment['id'].'.selector',['checked'=>false,'label'=>false])."</td>";
