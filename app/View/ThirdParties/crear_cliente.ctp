...
<div class="thirdParties clients fullwidth">
<?php 
      ...
      echo "<div class='row'>";	
        ...
        echo '<div class="col-sm-2">';
          ...
          echo '<ul style="list-style:none;">';
            echo "<li>".$this->Html->link(__('List Clients'), ['action' => 'resumenClientes'])."</li>";
            echo "<br/>";
            ...
            if ($bool_sale_add_permission) {
              echo "<li>".$this->Html->link(__('New Sale'), ['controller' => 'orders', 'action' => 'crearVenta'])."</li>";
            }
            if ($bool_remission_add_permission) {
              echo "<li>".$this->Html->link(__('New Remission'), ['controller' => 'orders', 'action' => 'crarRemision'])."</li>";
            }
          echo "</ul>";
        echo '</div>';          
      echo "</div>";
