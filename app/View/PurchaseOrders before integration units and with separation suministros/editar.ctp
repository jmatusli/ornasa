...
<script>
  ...
  function setCreditConditions(){      
	...
	function updatePackagagingUnit(rowId){
    var thisRow=$('#purchaseOrderProducts').find("tr[row='" + rowId + "']");
    
    var productId=thisRow.find('td.productid div select').val();
    
    var productPackagingUnitInput=thisRow.find('.productpackagingunit');
  ...
  function updateProductCost(rowId){
    var thisRow=$('#purchaseOrderProducts').find("[row='" + rowId + "']");
    
    var productId=thisRow.find('td.productid div select option:selected').val();
