...
<?php echo $this->Form->create('ProductionMovement'); ?>
	<fieldset>
		<legend><?php echo __('Edit Production Movement'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<!--li><?php // echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ProductionMovement.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('ProductionMovement.id'))); ?></li-->
