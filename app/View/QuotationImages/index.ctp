<div class="quotationImages index">
<?php 
	echo "<h2>".__('Quotation Images')."</h2>";
...
<?php
	...
	foreach ($quotationImages as $quotationImage){ 
		$pageRow=""		$pageRow=""		$pageRow.="<td>".$this->Html->link($quotationImage['Quotation']['quotation_code'], array('controller' => 'quotations', 'action' => 'view', $quotationImage['Quotation']['id']))."</td>";
		$pageRow=""		$pageRow.="<td>".h($quotationImage['QuotationImage']['url_image'])."</td>";
		$pageRow=""		$pageRow=""
			$excelBody.="<tr>".$pageRow."</tr>";

			$pageRow.="<td class='actions'>";
				$pageRow.=$this->Html->link(__('View'), array('action' => 'view', $quotationImage['QuotationImage']['id']));
				$pageRow.=$this->Html->link(__('Edit'), array('action' => 'edit', $quotationImage['QuotationImage']['id']));
				//$pageRow.=->postLink(__('Delete'), array('action' => 'delete', $quotationImage['QuotationImage']['id']), array(), __('Are you sure you want to delete # %s?', $quotationImage['QuotationImage']['id']));
			$pageRow.="</td>";
