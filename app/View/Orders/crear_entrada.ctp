...
<script>
  ...
  */
  ...
  $('body').on('submit','#OrderCrearEntradaForm',function(e){	
...
<?php 
  echo "<div id='saving' style='min-height:180px;z-index:9998!important;position:relative;'>";
    echo "<div id='savingcontent'  style='z-index:9999;position:relative;'>";
      echo "<p id='savingspinner' style='font-weight:700;font-size:24px;text-align:center;z-index:100!important;position:relative;'>Guardando la entrada...</p>";
    echo "</div>";
  echo "</div>";
  echo "<div id='mainform'>";
    echo $this->Form->create('Order'); 
    echo "<fieldset>";
      echo "<legend>Crear Nueva Entrada</legend>";
      ...
      echo '<div class="container-fluid">';
        echo '<div class="row">';
          echo '<div class="col-sm-8">';
            ...
            echo $this->Form->input('bool_entry_iva',['type'=>'checkbox','label'=>'Se aplica IVA','checked'=>true,]);
          echo '</div>';
