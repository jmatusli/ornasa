...
<?php echo $this->Form->create('QuotationProduct'); ?>
	<fieldset>
		<legend><?php echo __('Edit Quotation Product'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('QuotationProduct.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('QuotationProduct.id'))); ?></li>
