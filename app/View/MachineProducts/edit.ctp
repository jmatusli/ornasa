...
<?php echo $this->Form->create('MachineProduct'); ?>
	<fieldset>
		<legend><?php echo __('Edit Machine Product'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MachineProduct.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('MachineProduct.id'))); ?></li>
