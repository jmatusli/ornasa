...
<?php
  ...
  $output.="<table>";
      ...
      $output.="<td style='width:50%'>";
		...
		$output.="<tr>";
      $output.="<td style='width:50%'>";
			$output.="<div>QUEDA ".$productionRun['RawMaterial']['name']." ".$productionRunDateTime->format('d-m-Y').": <span class='underline'>".number_format($remainingPreformaProductionRunDate[0][0]['Remaining'],0,".",",")."</span></div>";
			$output.="</td>";
			$output.="<td style='width:50%'>";
    ...
    $output.="<tr>";
      $output.="<td style='width:50%'>";
			$output.="<div>QUEDA ".$productionRun['RawMaterial']['name']." ".$nowDateTime->format('d-m-Y').": <span class='underline'>".number_format($remainingPreformaNow[0][0]['Remaining'],0,".",",")."</span></div>";
			$output.="</td>";
			$output.="<td style='width:50%'>";
