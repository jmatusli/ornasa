<div class="salesOrderProductStatuses index">
<?php 
	echo "<h2>".__('Sales Order Product Statuses')."</h2>";
...
<?php
	...
	$pageHeader.="<thead>";
		$pageHeader.="<tr>";
			$pageHeader.="<th>".$this->Paginator->sort('status')."</th>";
			$pageHeader.="<th class='actions'>".__('Actions')."</th>";
		$pageHeader.="</tr>";
	$pageHeader.="</thead>";
	$excelHeader.="<thead>";
		$excelHeader.="<tr>";
			$excelHeader.="<th>".$this->Paginator->sort('status')."</th>";
		$excelHeader.="</tr>";
	$excelHeader.="</thead>";
	...
	foreach ($salesOrderProductStatuses as $salesOrderProductStatus){ 
		$pageRow="";
			$pageRow.="<td>".h($salesOrderProductStatus['SalesOrderProductStatus']['status'])."</td>";

			$excelBody.="<tr>".$pageRow."</tr>";

			$pageRow.="<td class='actions'>";
				$pageRow.=$this->Html->link(__('View'), array('action' => 'view', $salesOrderProductStatus['SalesOrderProductStatus']['id']));
				$pageRow.=$this->Html->link(__('Edit'), array('action' => 'edit', $salesOrderProductStatus['SalesOrderProductStatus']['id']));
				//$pageRow.=->postLink(__('Delete'), array('action' => 'delete', $salesOrderProductStatus['SalesOrderProductStatus']['id']), array(), __('Are you sure you want to delete # %s?', $salesOrderProductStatus['SalesOrderProductStatus']['id']));
			$pageRow.="</td>";
