...
<?php echo $this->Form->create('StockItemLog'); ?>
	<fieldset>
		<legend><?php echo __('Edit Stock Item Log'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('StockItemLog.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('StockItemLog.id'))); ?></li>
