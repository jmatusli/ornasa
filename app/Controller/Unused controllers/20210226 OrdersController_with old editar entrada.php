...
class OrdersController extends AppController {
  ...
  public function beforeFilter() {
		parent::beforeFilter();
		$this->Auth->allow('setDueDate','imprimirVenta','guardarResumenVentasRemisiones','guardarResumenDescuadresSubtotalesSumaProductosVentasRemisiones','guardarResumenDescuadresRedondeoSubtotalesIvaTotalesVentasRemisiones','guardarResumenComprasRealizadas','verPdfEntrada','verPdfVenta','verPdfRemision','sortByTotalForClient','guardarReporteCierre','guardarReporteVentasCliente','verPagoEntradas','verPagoEntradasPdf');		
	}
