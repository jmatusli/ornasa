...
class PurchaseOrder extends AppModel {
  ...
  public function getConfirmedPurchaseOrders($warehouseId,$boolPackaging=0,$purchaseOrderId=0){
    if ($purchaseOrderId >0){
      $purchaseOrders=$this->find('list',[
        'conditions'=>[
          'OR'=>[
            //'purchase_order_state_id'=>[PURCHASE_ORDER_STATE_CONFIRMED_WITH_CLIENT,PURCHASE_ORDER_STATE_RECEIVED_PARTIALLY],
            [
              'purchase_order_state_id'=>[PURCHASE_ORDER_STATE_CONFIRMED_WITH_CLIENT],
              'warehouse_id'=>$warehouseId,  
              'bool_annulled'=>false,
              'bool_packaging'=>$boolPackaging,
            ],
            [
              'id'=>$purchaseOrderId,
              'warehouse_id'=>$warehouseId,
