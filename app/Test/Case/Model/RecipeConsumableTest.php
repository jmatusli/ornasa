<?php
App::uses('RecipeConsumable', 'Model');

/**
 * RecipeConsumable Test Case
 *
 */
class RecipeConsumableTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->RecipeConsumable = ClassRegistry::init('RecipeConsumable');
	}
