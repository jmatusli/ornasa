<?php
App::uses('PurchaseOrderState', 'Model');

/**
 * PurchaseOrderState Test Case
 *
 */
class PurchaseOrderStateTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->PurchaseOrderState = ClassRegistry::init('PurchaseOrderState');
	}
