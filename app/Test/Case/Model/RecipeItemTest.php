<?php
App::uses('RecipeItem', 'Model');

/**
 * RecipeItem Test Case
 *
 */
class RecipeItemTest extends CakeTestCase {
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->RecipeItem = ClassRegistry::init('RecipeItem');
	}
